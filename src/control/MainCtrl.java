...
public class MainCtrl extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("addpinlun"))
		{
			 ...
			 String sql = "insert into pinlun values(null,'"+user2+"','"+content+"','"+date+"','"+proid+"') ";
		...
		if(ac.equals("addgl"))
		{
			String uname = Info.getGB2312Str(request.getParameter("uname") );
		     ...
		     String PID = Info.getUTFStr(request.getParameter("PID"));
				String sql = "insert into buser(uname,upass,tname,sex,age,tel,addr,email,PID,utype,state,savetime) values(" +
						"'"+uname+"'," +
						"'"+upass+"'," +
						"'"+tname+"'," +
						"'"+sex+"'," +
