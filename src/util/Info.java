...
public class Info {
	...
	System.out.print(Info.getBetweenDayNumber("2012-11-11 11:19", "2012-11-11 11:11"));
	 ...
	 public static String getselect(String name,String tablename,String zdname,String where)
	 {
		 ...
		 String select = "<select name=\""+name+"\" id=\""+name+"\" >";
		 select+="<option value=\"\">unlimit</option>";
		 for(HashMap permap:new CommDAO().select("select * from "+tablename+" where "+where+" order by id desc")){ 
			 ...
			 if(zdname.split(";").length==1){
				 ...
				 for(String str:zdname.split(";"))
				 {
					 ...
					 String zdnamestr = str.split("~")[1].equals("none")?"":(str.split("~")[1]+":");
	 ...
	 public static void writeExcel(String fileName,String prosstr,java.util.List<List> list,HttpServletRequest request, HttpServletResponse response){    
		 WritableWorkbook  wwb = null;    
	        ...
	        try {
				response.sendRedirect("/frolstore/upload?filename="+fileName.substring(fileName.lastIndexOf("/")+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
	 ...
	 public static String getFileUpInfo()
		{
			String jscode = "";
			jscode+="<script src=/frolstore/js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc()\" src=\"js/nopic.jpg\" style='cursor:hand' id=txt >upload</font>";
	 ...
	 public static String getFileUpInfo2()
		{
			String jscode = "";
			jscode+="<script src=/frolstore/js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc2()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt2 >upload</font>";
	 ...
	 public static String getFileUpInfo3()
		{
			String jscode = "";
			jscode+="<script src=/frolstore/js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc3()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt3 >upload</font>";
	 ...
	 public static String getFileUpInfo4()
		{
			String jscode = "";
			jscode+="<script src=/frolstore/js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc4()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt4 >upload</font>";
	 ...
	 public static String getFileUpInfo5()
		{
			String jscode = "";
			jscode+="<script src=/frolstore/js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc5()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt5 >upload</font>";
	  ...
	  public static String tform(HashMap map)
		{
	    	...
	    	Set set = map.entrySet();
	    	 ...
	    	 jscode+=" if(f1."+str1+")\n";
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txtext\").src=\"/frolstore/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	    	
	    	  jscode+="if(document.getElementById(\"txt\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt\").src=\"/frolstore/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt2\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt2\").src=\"/frolstore/upfile/"+map.get("filename2")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt3\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt3\").src=\"/frolstore/upfile/"+map.get("filename3")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt4\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt4\").src=\"/frolstore/upfile/"+map.get("filename4")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt5\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt5\").src=\"/frolstore/upfile/"+map.get("filename5")+"\";\n";
	    	  jscode+="}\n";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/frolstore/js/nopic.jpg\" id=txtext height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/frolstore/js/popups.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/frolstore/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/frolstore/js/popups.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/frolstore/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/frolstore/js/popup.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/frolstore/js/nopic.jpg\" id=txt3 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/frolstore/js/nopic.jpg\" id=txt4 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/frolstore/js/nopic.jpg\" id=txt5 height=\""+height+"\"/>";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/frolstore/fckeditor/fckeditor.js\"></script>";
		jscode+="<script language=\"javascript\">";
		jscode+="function fckinit()";
		jscode+="{";
		jscode+=" var of = new FCKeditor(\"content\");";
		jscode+="of.BasePath=\"/frolstore/fckeditor/\";";
