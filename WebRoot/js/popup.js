...
function uploadimg()
{
pop("/frolstore/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/frolstore/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/frolstore/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/frolstore/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/frolstore/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/frolstore/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/frolstore/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/frolstore/js/uploaddoc3.jsp","docupload",300,77)
}

function uploaddoc4()
{
pop("/frolstore/js/uploaddoc4.jsp","docupload",300,77)
}

function uploaddoc5()
{
pop("/frolstore/js/uploaddoc5.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/frolstore/js/dialogclose.gif  />';
