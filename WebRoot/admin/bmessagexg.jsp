...
%>
<body>
<form  action="bmessagexg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post"  onsubmit="return checkform()" >
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" colspan="2" align="center"><strong>Reply messages</strong></td>
  </tr>
  <tr>
    <td width="351" height="34" align="center">reply</td>
  ...
  <tr>
    <td height="38" colspan="2" align="center"><label>
      ...
      <input type=button value='return' onclick='popclose();' />
    </label></td>
  </tr>
</table>
</form>
