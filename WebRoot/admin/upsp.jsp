...
%>
<body>
<form  action="upsp.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post"  onsubmit="return checkform()" >
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" colspan="2" align="center"><strong>Modify products</strong></td>
  </tr>
  <tr>
...
<tr>
    ...
    <td width="1024" height="28" align="left"><%=Info.getselect("protype","protype","typename"," 1=1 ")%><label id='clabelprotype' />
</td>
  </tr>
<tr>
...
<tr>
    <td width="221" height="34" align="center">Amount </td>
...
if(tgrsobj.value==""){  
document.getElementById("clabeltgrs").innerHTML="&nbsp;&nbsp;<font color=red>Input amount</font>";  
return false;  
}else{ 
