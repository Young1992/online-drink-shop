  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
  	<tr>
	      ...
	      <tr>
	        ...
	        <td width="281" background="/frolstore/admin/images/tab_05.gif" align="right">
	        
	        <a href="addgl.jsp">Add admin</a>
...
PageManager pageManager = PageManager.getPage("/frolstore/glgl.jsp?1=1",10, request);
...
for(HashMap h:nlist)
{
 %>
          ...
          <td height="26" align="center" bgcolor="#FFFFFF" class=""><a href="/frolstore/admin/upmember.jsp?id=<%=h.get("id") %>">Change</a>      </td>    
          <td height="26" align="center" bgcolor="#FFFFFF" class="">
          <a href="/frolstore/admin/glgl.jsp?did=<%=h.get("id") %>">Delete</a>            </td>
          </tr>
 <%
 }
  %>          
