...
if(suc!=null)
{
 ...
 <%
  ...
  <form action="/frolstore/Regeditgl" name="f1" method="post" >
        ...
        <td>
            ...
            cellspacing="0"frolstorestyle="WIDTH: 100%; BORDER-COLLAPSE: collapse">
             ...
             <tr 
              ...
              >
                          <td height="40" colspan="2" align="center" class="main_matter_td"><strong>add admin</strong>
                        <label></label></td>
                      </tr>
              ...
              >
                          ...
                          <td align="left" class="main_matter_td"><input type="radio" name="sex"   id="radio3" value="Male" />
Male
  <input type="radio" name="sex" id="radio4"    value="Female" />
Female </td>
                        </tr>
                        <tr 
              ...
              >
                          ...
                          <td align="left" class="main_matter_td"><input class="textBox" name="PID" size="25" /></td>
                        </tr>
