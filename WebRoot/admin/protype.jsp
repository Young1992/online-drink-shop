...
if(error!=null)
{
 ...
 <%
  ...
  for(HashMap h:dlist)
  {
  Info.delPic("/frolstore/upfile/",(String)h.get("img"));
  }
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td height="18" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">Category</td>
            <td width="8%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">Delete</td>
             <td height="18" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">Category</td>
            <td width="8%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">Delete</td>
          </tr>
     ...
     ii++;
           ...
           <a href="/frolstore/admin/protype.jsp?did=<%=h.get("id") %>"> delete</a>
...
<tr>
		  <td height="24" colspan="2" align="center" ><strong></strong><label></label>
	        <strong>Add category</strong><br></td>
</tr>
    
    <tr>
		  <td width="23%" align="center" >Input category<br></td>
