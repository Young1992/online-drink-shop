...
<input type=submit class='' value='search info' />
 &nbsp;&nbsp;
<input type=button   class='' value='add info' onclick="window.location.replace('fbhd.jsp')" /> 
&nbsp;&nbsp;</td>
    </tr>
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">Title</td>
...
<a href="uphd.jsp?id=<%=map.get("id")%>">Change</a>
&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;

<a onclick="return confirm('Sure to delete this one?')" href="hdgl.jsp?scid=<%=map.get("id")%>">Delete</a>
</td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('uphd.jsp?id='+no,'Change info',550,'100%') 
}
</script> 
<script language=javascript> 
function add(){ 
pop('fbhd.jsp','Add info',550,'100%') 
}
</script> 
<%@page import="util.Info"%> 
<%@page import="java.util.ArrayList"%> 
