                  ...
                  bgColor=#ffffff border=0>
                    ...
                    <TR>
                      <TD class=orangelight align=center width=500 
                        bgColor=#F6E1DE>Product name</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight><LABEL>Price</LABEL></TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Amount</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Picture</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Address</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Delivery</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Payment</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Phone</TD>
                      <TD width="500" align=center 
                        bgColor=#F6E1DE class=orangelight>Status</TD>
                    </TR>
...
PageManager pageManager = PageManager.getPage("/frolstore/fcdd.jsp?1=1", 10, request);
                  ...
                  <TR>
                      ...
                      <TD width="500" align=center ><%=p.get("mprice") %> EUR <%=p.get("discount").equals("no discount")?"no discount":p.get("discount")+"discount" %></TD>
                       <TD width="500" align=center ><%=p.get("num") %>selected</TD>
                       <TD width="500" align=center  ><img src="/frolstore/upfile/<%=p.get("filename") %>" height="60" /></TD>
