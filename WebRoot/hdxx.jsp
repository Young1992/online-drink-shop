                ...
                <TD>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <a href="/frolstore/"><span class="STYLE4" style=" color:#CC6633">Latest products</span></a>
                      <%
                      ...
                      <%} %>
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp; 
                      <a href="/frolstore/hdxx.jsp"><span class="STYLE4" style=" color:red">Check news</span></a>
...
sql+="order by a.id desc ";
  ...
  int i=0;
PageManager pageManager = PageManager.getPage("/frolstore/hdxx.jsp?1=1",4, request);
					  ...
					  <table cellspacing=0 cellpadding=2 width="100%" border=0>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <img height=80 width="90" src="/frolstore/upfile/<%=h.get("filename") %>" align=left border=0></td>
                              <td width="87%" align="left"><a href="/frolstore/hdxiang.jsp?id=<%=h.get("id")%>" >
