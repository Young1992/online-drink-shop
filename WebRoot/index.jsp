                ...
                <TD>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <a href="/frolstore/"><span class="STYLE4" style=" color:#CC6633">All products</span></a>
                      ...
                      for(HashMap m:typelist){
                       %>
                      &nbsp;&nbsp;&nbsp;&nbsp; 
                      <a href="/frolstore/index.jsp?f=f&key=<%=m.get("typename") %>"><span class="STYLE4" style=" color:#CC6633"><%=m.get("typename") %></span></a>
                      <%} %>
                      
                       &nbsp;&nbsp;&nbsp;&nbsp; 
                      <a href="/frolstore/hdxx.jsp"><span class="STYLE4" style=" color:red">News</span></a>
...
String sql = "select * from pros a where status='Instore' ";
...
sql+="order by a.id desc ";
  ...
  int i=0;
PageManager pageManager = PageManager.getPage("/frolstore/index.jsp?1=1",12, request);
					  ...
					  <table cellspacing=0 cellpadding=2 width="229%" border=0>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <img height=80 src="/frolstore/upfile/<%=h.get("filename") %>" width=92 align=left border=0></td>
                              <td width="82%" align="left"><a href="/frolstore/xiang.jsp?id=<%=h.get("id")%>" >
                           ...
                           <font  color=red>Price: <%=h.get("mprice") %></font>
                             
                                  
                                  </td>
                            </tr>
                            <tr>
                              <td width="82%" align="left">Expiration: <font 
                              color=><font  color=black><%=h.get("cpcj") %></font></td>
                            </tr>
                             <tr>
                              <td width="82%" align="left">Discount: <font 
                              color=><%=!h.get("discount").equals("no discount")?h.get("discount")+" %off":"no discount" %></font></td>
                            </tr>
                          </tbody>
                      </table>				</td>
			 <%
